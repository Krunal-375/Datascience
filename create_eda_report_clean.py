...
def add_italic_placeholder(doc, text):
    """Add an italic placeholder paragraph"""
...
def create_eda_report():
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cell 3 - Data Loading and Initial Exploration]")
    ...
    doc.add_heading('Key Statistical Measures:', 3)
    measures = [
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cell 7 - Descriptive Statistics Analysis]")
    ...
    doc.add_heading('3.1 Data Cleaning Strategy:', 2)
    cleaning_steps = [
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cell 9 - Data Quality Assessment before vs after comparison]")
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 37-41 - Outlier Detection visualization charts]")
    
    # 5. Univariate Analysis Insights
    doc.add_heading('5. Univariate Analysis Insights', 1)
    
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 16-20 - Univariate analysis visualizations]")
    
    doc.add_heading('5.1 Key Findings:', 2)
    
    doc.add_heading('Numerical Variables:', 3)
    numerical_insights = [
    ...
    doc.add_heading('Categorical Variables:', 3)
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 24-28 - Correlation matrix and bivariate visualizations]")
    
    doc.add_heading('6.1 Significant Relationships:', 2)
    relationships = [
    ...
    doc.add_heading('7.1 Principal Component Analysis:', 2)
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 31-34 - PCA analysis with component interpretation]")
    
    doc.add_heading('7.2 Clustering Analysis:', 2)
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 31-34 - Clustering analysis results]")
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 45-47 - District-wise financial skewness analysis]")
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 49-52 - Hypothesis testing and ANOVA results]")
    ...
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 60-61 - Time series analysis and trends]")
    ...
    doc.add_heading('11. Machine Learning Recommendations', 1)
    
    add_italic_placeholder(doc, "[Placeholder: Cell output from Cold_Chain_EDA.ipynb Cells 64-70 - ML readiness assessment]")
    
    doc.add_heading('11.1 Recommended Algorithms:', 2)
    
    doc.add_heading('Classification Problems:', 3)
    classification_problems = [
        "Project Success Prediction - Target: Project status - Algorithms: Random Forest, Logistic Regression",
        "District Performance Classification - Target: Performance categories - Algorithms: Gradient Boosting"
    ]
    ...
    regression_problems = [
        "Cost Prediction Models - Target: Project cost estimation - Algorithms: Ridge Regression",
        "Funding Optimization - Target: Optimal sanctioned amounts - Algorithms: Ensemble methods"
    ]
    for problem in regression_problems:
        doc.add_paragraph(problem, style='List Bullet')
    
    doc.add_heading('11.2 Advanced Analytics:', 2)
    analytics_opportunities = [
        "Time Series Analysis: Investment forecasting using ARIMA, LSTM models",
        "Clustering: District segmentation using K-means clustering",
        "Network Analysis: State-District relationships using graph analytics"
    ]
    ...
    doc.add_heading('12.1 Immediate Actions (0-6 months):', 2)
    immediate_actions = [
    ...
    doc.add_heading('12.2 Medium-term Initiatives (6-18 months):', 2)
    medium_term = [
    ...
    doc.add_heading('12.3 Expected Outcomes:', 2)
    outcomes = [
    ...
    footer_run = footer.add_run(
        ...
        "in India's cold chain infrastructure development."
    )
...
def main():
    ...
    print(f"📋 Placeholders include specific cell numbers from Cold_Chain_EDA.ipynb")
